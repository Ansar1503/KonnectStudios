function DashboardHeader() {
  return (
    <div className="flex justify-between items-center px-8 py-8 bg-neutral-950 border-b border-neutral-900">
        ...
        <button className="bg-neutral-100 text-neutral-900 px-5 py-2 text-sm font-semibold cursor-pointer rounded-lg hover:bg-neutral-200 active:scale-95 transition-all shadow-sm">
            + New Booking
        </button>
    </div>
  )
